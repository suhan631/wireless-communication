...
fprintf('percentage_market_penetration_for_A: %.2f%%\n\n',percentage_market_penetration_for_A);
disp('For system B')
channel_b=57;
cell_B=98;
Ab=45;
...
fprintf('percentage_market_penetration_for_B: %.2f%%\n\n',percentage_market_penetration_for_B);
disp('For system C')
channel_c=100;
cell_C=49;
Ac=88;
...
fprintf('percentage_market_penetration_for_C: %.2f%%\n\n',percentage_market_penetration_for_C);
...
fprintf('Market_penetration_for_three_system: %.2f%%\n',Market_penetration_for_three_system);